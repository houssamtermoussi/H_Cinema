            ...
            <div class="container mx-auto px-4 max-w-7xl">
                <div class="flex flex-col md:flex-row justify-between items-center gap-8 mb-12 border-b border-gray-800 pb-12">
                    ...
                    <div class="flex flex-col items-center gap-3 text-center">
                        ...
                        <a href="mailto:houssam111888@gmail.com" class="text-gray-300 hover:text-[#cc0000] flex items-center gap-2 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                            </svg>
                            houssam111888@gmail.com
                        </a>
                    ...
                    <div class="flex flex-col items-center md:items-end">
                        ...
                        <div class="flex gap-4">
                            <a href="https://github.com/houssamtermoussi" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#cc0000] transition-colors duration-300">
                            ...
                            <a href="https://www.instagram.com/h0uss4m.t/" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#cc0000] transition-colors duration-300">
                            ...
                            <a href="https://fr.pinterest.com/houssam111888/" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#cc0000] transition-colors duration-300">
