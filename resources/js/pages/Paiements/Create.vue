...
const breadcrumbs = [
    { title: 'RÃ©servations', href: '/reservations' },
    { title: 'Paiement', href: '#' }
];
        ...
        <div class="min-h-screen bg-zinc-950 flex flex-col items-center py-20 px-8">
            <div class="max-w-xl w-full">
                <div class="text-center mb-12">
                    ...
                    <h1 class="text-4xl font-black text-white mb-2 tracking-tighter">PAIEMENT SÃ‰CURISÃ‰</h1>
                    <p class="text-zinc-500 font-medium">Finalisez votre rÃ©servation pour {{ reservation.seance.film.titre }}</p>
                </div>
                ...
                <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-[2.5rem] overflow-hidden shadow-2xl">
                    ...
                    <div class="p-10 border-b border-zinc-800/50 bg-zinc-900/30">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-1">Montant Ã  rÃ©gler</h3>
                                <p class="text-5xl font-black text-white tracking-tighter">{{ montant.toFixed(2) }}â‚¬</p>
                            </div>
                ...
                <p class="mt-12 text-center text-zinc-600 text-[10px] font-black uppercase tracking-[0.2em]">
                    CertifiÃ© SSL â€” SÃ©curitÃ© Bancaire niveau 4
                </p>
            </div>
        </div>
    </AppLayout>
